...
foreach ($data_provinsi as $key => $provinsi) {
    // if ($key < 1 && $key > 4) continue; //1
    // if ($key < 5 && $key > 9) continue; //2
    // if ($key < 10 && $key > 14) continue; //3
    // if ($key < 15 && $key > 19) continue; //4
    // if ($key < 20 && $key > 24) continue; //5
    // if ($key < 25 && $key > 29) continue; //6
    // if ($key < 30 && $key > 34) continue; //7
    // if ($key > 4) continue; //1
